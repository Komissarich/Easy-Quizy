...
import (
	...
	api "awesomeProject2/pkg/api/v1"
...
type Repository interface {
	CreateQuiz(context.Context, string, string, []*v1.CreateQuestion) (string, error)
...
func (s *QuizService) CreateQuiz(ctx context.Context, req *api.CreateQuizRequest) (*api.CreateQuizResponse, error) {
	quiz_id, err := s.repo.CreateQuiz(ctx, req.Name, req.Author, req.Question)
	if err != nil {
