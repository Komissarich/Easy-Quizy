...
func (r *FriendRepository) GetFriendIDs(ctx context.Context, userID string) ([]string, error) {
...
func (r *FriendRepository) CheckFriendship(ctx context.Context, userID, friendID string) (bool, error) {
