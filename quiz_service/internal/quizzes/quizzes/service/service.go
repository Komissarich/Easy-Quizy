...
type Repository interface {
	CreateQuiz(context.Context, string, string, *string, *string, []*v1.CreateQuestion) (string, error)
...
func (s *QuizService) CreateQuiz(ctx context.Context, req *api.CreateQuizRequest) (*api.CreateQuizResponse, error) {
	quiz_id, err := s.repo.CreateQuiz(ctx, req.Name, req.Author, req.ImageId, req.Description, req.Question)
	if err != nil {
